...
> 也可以通过HttpSession的API 对最大闲置时间进行设定(秒)
...
public @interface WebFilter {
    ...
    String[] value() default {};//等价于urlPatterns(只有一个参数可以不写value)

    String[] urlPatterns() default {};//等价于value
...
![](E:\JavaInact\JavaWeb\笔记\images\同步和异步请求.png)
