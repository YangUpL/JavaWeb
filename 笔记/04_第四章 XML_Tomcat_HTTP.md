...
```xml
![javaAddXml](E:\JavaInact\JavaWeb\笔记\images\javaAddXml.png)<web-app xmlns="http://xmlns.jcp.org/xml/ns/javaee"
...
![](E:\JavaInact\JavaWeb\笔记\images\javaAddWeb1.png)

<img src="E:\JavaInact\JavaWeb\笔记\images\JavaAddWeb2.png" style="zoom:150%;" />

- 普通java文件取消web目录依赖

![](E:\JavaInact\JavaWeb\笔记\images\javaDelWeb1.png)

![](E:\JavaInact\JavaWeb\笔记\images\javaDelWeb2.png)

![](E:\JavaInact\JavaWeb\笔记\images\JavaDelWeb3.png)

## 1.2 DOM4J进行XML解析

- 编译生成字节码文件

![](E:\JavaInact\JavaWeb\笔记\images\bianyishengchengzijiemawenjian.png)

![](E:\JavaInact\JavaWeb\笔记\images\buianyishengchengzijiemawenjian2.png)
...
![](E:\JavaInact\JavaWeb\笔记\images\Dom4jUse.png)
...
- conf：这是一个非常非常重要的目录，这个目录下有四个最为重要的文件：
    ...
    - logging.properties：编码更改处

        - ![](E:\JavaInact\JavaWeb\笔记\images\luanmajiejuedizhi.png)
...
+ idea的tomcat副本在C:\用户\当前用户\AppData\Local\JetBrains\IntelliJIdea2022.2\tomcat\中
  + **我的：**C:\Users\31841\AppData\Local\JetBrains
  + conf/localhost/.xml配置文件信息：<Context path="/demo01_web01" docBase="E:\JavaInact\JavaWeb\self\demo5_web-all\out\artifacts\demo01_web01_war_exploded" />
...
> 在HTTP1.0版本中，浏览器请求一个带有图片的网页，会由于下载图片而与服务器之间开启一个新的连接(短连接)；但在HTTP1.1版本中，允许浏览器在拿到当前请求对应的全部资源后再断开连接，提高了效率(长连接)。
