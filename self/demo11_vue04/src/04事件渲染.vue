...
<template>
  <div>
    ...
    <a href="http://www.atguigu.com" target="_blank" @click.prevent="count++">prevent_vue</a> <br>
    <!-- 原生js方式阻止组件默认行为 (推荐) -->
    <a href="http://www.atguigu.com" target="_blank" @click="incrCount($event)">prevent_js</a> <br>
  </div>
</template>
